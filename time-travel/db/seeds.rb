...
User.create([
  ...
  {first_name:"Annabelle",last_name:"Thaddeus",email:"abt@gotexas.com",image:"http://donatered-asset.s3.amazonaws.com/assets/default/default_user-884fcb1a70325256218e78500533affb.jpg"}
  ])
